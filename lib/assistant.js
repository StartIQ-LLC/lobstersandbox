...
A: After setup, you'll need to: 1) Get a separate phone number (eSIM on spare phone recommended), 2) Configure channels.whatsapp in your config, 3) Run "openclaw channels login" to scan the QR code, 4) Start the gateway. Use "pairing" or "allowlist" mode to control who can message you.
